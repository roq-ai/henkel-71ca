  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless operations with Henkel - where admins manage company details and users access data with ease. Your gateway to efficient business management."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1474377207190-a7d8b3334068?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhZG1pbnxlbnwwfHx8fDE2OTAxNzcxNzZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@olidale?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Oli Dale`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless operations with Henkel - where admins manage company details and users access data with ease. Your gateway to efficient business management.`}
            </Text>
            <Box
